...
LOCAL_MODULE := android.hardware.power@1.3-service.samsung-a70q
...
LOCAL_POST_INSTALL_CMD := mkdir -p $(TARGET_OUT_PRODUCT)/vendor_overlay/29/lib64
LOCAL_POST_INSTALL_CMD += ; touch $(TARGET_OUT_PRODUCT)/vendor_overlay/29/lib64/libperfmgr.so
